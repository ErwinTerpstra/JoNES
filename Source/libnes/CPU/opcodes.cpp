...
const Instruction CPU::INSTRUCTION_MAP[] =
{
	...
	{ 0x1A, 1, ADDR_IMPL,			"NOP", &CPU::nop },
	{ 0x1B, 1, ADDR_INVALID, "", NULL },
	{ 0x1C, 1, ADDR_ABSX,			"NOP", &CPU::nop },
	...
	{ 0x3A, 1, ADDR_IMPL,			"NOP", &CPU::nop },
	{ 0x3B, 1, ADDR_INVALID, "", NULL },
	{ 0x3C, 1, ADDR_ABSX,			"NOP", &CPU::nop },
	...
	{ 0x5A, 1, ADDR_IMPL,			"NOP", &CPU::nop },
	{ 0x5B, 1, ADDR_INVALID, "", NULL },
	{ 0x5C, 1, ADDR_ABSX,			"NOP", &CPU::nop },
	...
	{ 0xBF, 1, ADDR_ABSY,			"LAX", &CPU::lax },

	{ 0xC0, 1, ADDR_IMM,			"CPY", &CPU::cpy },
	{ 0xC1, 1, ADDR_IZPX,			"CMP", &CPU::cmp },
	{ 0xC2, 1, ADDR_IMM,			"NOP", &CPU::nop },
	...
	{ 0xDA, 1, ADDR_IMPL,			"NOP", &CPU::nop },
	{ 0xDB, 1, ADDR_INVALID, "", NULL },
	{ 0xDC, 1, ADDR_ABSX,			"NOP", &CPU::nop },
	...
	{ 0xFA, 1, ADDR_IMPL,			"NOP", &CPU::nop },
	{ 0xFB, 1, ADDR_ABSX,			"NOP", &CPU::nop },
	{ 0xFC, 1, ADDR_ABSX,			"NOP", &CPU::nop },
